...
import torch
from .processing_utils import sample_target
# for debug
import cv2
import os
from lib.models.tracking_engine_1 import build_TE_1_cvt_online_score
...
class TE_1_Online(BaseTracker):
    def __init__(self, params, dataset_name):
        super(TE_1_Online, self).__init__(params)
        network = build_TE_1_cvt_online_score(params.cfg, train=False)
    ...
    def initialize(self, image, info: dict):
        ...
        z_patch_arr, _, z_amask_arr = sample_target(image,
                                                    info['init_bbox'],
    ...
    def track(self, image, info: dict = None):
        ...
        if self.save_all_boxes:
            ...
            return {"target_bbox": self.state, "all_boxes": all_boxes_save, "score": pred_score}
            return {"target_bbox": self.state, "all_boxes": all_boxes_save}
        else:
            return {"target_bbox": self.state, "score": pred_score}
