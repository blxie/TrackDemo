...
class Tracker:
    ...
    def __init__(self,
        ...
        tracker_module_abspath = os.path.abspath(
            os.path.join(os.path.dirname(__file__), '..', 'tracker', '%s.py' % self.name))
    ...
    def run_video(self, videofilepath, optional_box=None, debug=None, visdom_info=None, track_res_file=None):
